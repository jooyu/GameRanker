...
//
//import com.zy.rank.core.base.IRank;
//import com.zy.rank.core.base.Rank;
//import com.zy.rank.core.base.RankConfigure;
...
//		// final List<Integer> ids = SetUniqueList.decorate(new
//		// ArrayList<Integer>());
...
//						// value4 = value%1000;
//						long value1 = value / 1000000l, value2 = value % 1000000l / 100, value3 = value % 100l;
//						// value4 = value%100l;
...
//			for (int i = 0; i < 10; i++) {
//				int testGetId = i * (threadCount * countPerThread / 10)/*
//																		 * +54+(i
//																		 * *10)
//																		 */;
//				if (isRedis) {
//					System.out.println(pool.getResource().zrevrank(testKey,
//							testKey + testGetId)
//							+ ",value:"
//							+ pool.getResource().zscore(testKey,
//									testKey + testGetId));
//				}
...
//			// null rankdata
//			System.out
//					.println("----------------------null rankdata---------------------");
//			for (Integer integer : nullRankDatas) {
//				RankData rankData = rank.get(integer);
//				long redisRank = -1;
//				if (isRedis) {
//					redisRank = pool.getResource().zrevrank(testKey,
//							testKey + integer);
//				}
//				System.err.println("id:" + integer + ",rank:" + rankData
//						+ ",redisRank:" + redisRank);
//			}
//			System.out
//					.println("----------------------null rankdata end---------------------");
//			// List<RankData> rankDatas =
//			// rank.getRankDatasByRankNum(rankData2.getRankNum() - 7, 11);
...
//			System.out.println(rank.rankStatisticsInfo());
//			if (isRedis) {
//				System.err.println("redis:set1:" + (t2 - t1) / 1000000
//						+ ",get1:" + (t3 - t2) / 1000000);
//			}
//			System.err.println("rank:set1:" + (t4 - t3) / 1000000 + ",get1:"
//					+ (t5 - t4) / 1000000 + ",destroy:" + (t6 - t5) / 1000000);
...
//
//	/**
//	 * test3启动多个线程，不断的向rank中添加或修改排行， 初始添加十万个，然后每分钟添加十万个，修改十万个
//	 */
//	private void test3() {
//		final int threadCount = 200;
//		final int initValueCount = 100000;
...
//										+ rank.get(1234321 + i)
//										+ ","
//										+ jedis.zrevrank(redisKey, redisKey
//												+ (1234321 + i))
//										+ ",value:"
//										+ jedis.zscore(redisKey, redisKey
//												+ (1234321 + i)));
//
//					}
//
...
//					barrierAwait(barrier); // 所有线程到齐之后再开始
//					for (int i = 0; i < count; i++) {
//						setByType(type, createValue(index * count + i),
//								createId(index * count + i), jedis);
//					}
...
//		// return (i)%50136+1; //
//		// 这样会由于不同线程而导致不同的结果很正常，由于改变是顺序的，导致删除node的顺序及其不确定，对并发能力挑战很大
