...
import com.zy.rank.core.base.Rank.ReOperType;

public class RankConfigure {
	/**
	 * rank的配置 ReOperType scheduleThreadCount maxScheduleTime multiThreadCount
	 * warnReOperTimes errorReoperTimes
	 * 
	 * NodeStep.fullCount NodeStep.deleteCount NodeStep.maxHitTimes
	 * ElementStep.fullCount ElementStep.deleteCount
	 */
	// 默认值
	...
	// rankElement比较多，每个里面单独一个ConcurrentHashMap占用太多内存,
